...
from sm_data import generate_prediction_data, generate_NPI_prediction_data, get_isolation_data, get_test_positivity_rate
...
# Runs Walk forward cross validation x 5 and logs to MLflow
